...
class GameScene: SKScene, SKPhysicsContactDelegate{
    ...
    override func didMoveToView(view: SKView) {
        ...
        if(score == 0) {
            scoreLabelNode.text = String("TRAINTRACKS DEMO")
        } else {
    ...
    func resetScene (){
        Traintracks.instance().logEvent("FLAPPY_BIRD_RESTARTED", withEventProperties: ["currentScore": score])
    ...
    func didBeginContact(contact: SKPhysicsContact) {
        if moving.speed > 0 {
            if ( contact.bodyA.categoryBitMask & scoreCategory ) == scoreCategory || ( contact.bodyB.categoryBitMask & scoreCategory ) == scoreCategory {
                ...
                Traintracks.instance().logEvent("FLAPPY_BIRD_SCORED", withEventProperties: ["currentScore": score])
            } else {
                ...
                Traintracks.instance().logEvent("FLAPPY_BIRD_DIED", withEventProperties: ["currentScore": score])
